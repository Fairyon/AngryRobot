...
public class CokeDifferentialPilot extends DifferentialPilot {

  private static double rotationFactor = 1;
  private static double travelFactor = 1.07;

  public CokeDifferentialPilot(double wheelDiameter, double trackWidth,
